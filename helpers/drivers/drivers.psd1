@{
    Drivers = @(
        ...
        @{ IHV = 'Intel'    ; DriverFileName = 'v40e65.sys'    ; MinimumDriverVersion = '1.8.103.2'     }, # Intel X722 - Updated 6/14/2019
        ...
        @{ IHV = 'Mellanox' ; DriverFileName = 'mlx4eth63.sys' ; MinimumDriverVersion = '5.50.14688.0'  }, # ConnectX-3 - Updated to latest
        @{ IHV = 'Mellanox' ; DriverFileName = 'mlx5.sys'      ; MinimumDriverVersion = '2.20.21096.0'  }  # ConnectX-4 - Updated to latest
    )
}
