@{
    Drivers = @(
        ...
        @{ IHV = 'Chelsio'  ; DriverFileName = 'chnetx64.sys'  ; MinimumDriverVersion = '7.0.0.0'       }, # Chelsio
        ...
        @{ IHV = 'Intel'    ; DriverFileName = 'icea.sys'      ; MinimumDriverVersion = '1.9.62.0'      }, # Intel e810 - Updated 8/2/2021
